    ...
    <div class="col-md-12">
    	<form action="{{ route('psales.store') }}" method="POST" files="true" target="blank">
            	...
            	<div class="col-md-7">
	       		...
	       		<div class="col-md-5">
	       			<div class="row">
	       				...
	       				@endforeach
	       				<div class="col-md-2 packageCat" style="border: solid 2px #ec97ef; margin: 1px; height: 40px; width: 100px; background-color: #76d5e0;">
	       					<p class="packageCat">Package</p>
	       				</div>
	       			</div>
		    ...
		    <div class="form-group">
				...
				{{-- <a href="{{ URL::route('psales.index') }}" class="btn btn-warning btn-responsive" style="margin-bottom: 30px;">Cancel</a> --}}
			</div>
		</form>
	</div>
