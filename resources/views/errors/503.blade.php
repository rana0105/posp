...
<div class="ex-page-content bootstrap snippets" style="margin-top: 100px;">
    <div class="container">
        <div class="row">
            <div class="col-sm-6" style="text-align: center;">
                <svg class="svg-box" width="300px" height="350px" viewBox="0 0 837 1045" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
            ...
            <div class="col-sm-6">
                <div class="message-box">
                    ...
                    <h3>Oops! The Page is Service Unavailable !</h3>
                    <div class="buttons-con" style="margin-top: 50px;">
                        <div class="action-link-wrap" style="margin-left: 50px;">
                            {{-- <a href="#" class="btn btn-custom btn-info waves-effect waves-light m-t-20">Go Back</a> --}}
                            <a href="/dashboard" class="btn btn-custom btn-info waves-effect waves-light m-t-20">Go to Home Page</a>
                        </div>
                    </div>
                </div>
            </div>
